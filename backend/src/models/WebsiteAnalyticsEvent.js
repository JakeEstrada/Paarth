...
const EVENT_TYPES = ['page_view', 'click', 'contact_open', 'contact_submit'];
...
const websiteAnalyticsEventSchema = new mongoose.Schema(
  {
    ...
    href: { type: String, default: '', trim: true, maxlength: 400 },
    ...
    ip: { type: String, default: '', trim: true, maxlength: 64, index: true },
    userAgent: { type: String, default: '', trim: true, maxlength: 220 },
    locationCity: { type: String, default: '', trim: true, maxlength: 80 },
    locationRegion: { type: String, default: '', trim: true, maxlength: 80 },
    locationCountry: { type: String, default: '', trim: true, maxlength: 80 },
    locationLabel: { type: String, default: '', trim: true, maxlength: 200 },
    locationIsp: { type: String, default: '', trim: true, maxlength: 120 },
...
websiteAnalyticsEventSchema.index({ tenantId: 1, ip: 1, occurredAt: -1 });
